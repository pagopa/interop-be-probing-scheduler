...
public class ServicesSend {
  ...
  public void sendMessage(PollingActiveEserviceResponse service) throws IOException {
    ...
    log.info("Service with id" + service.getId() + " with version " + service.getVersionNumber()
